  ...
  return (
    <div className="p-6 md:p-10 max-w-6xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
        {/* Top 5 - Left */}
        <div ref={top5Section.ref} style={top5Section.style} className="md:col-span-3 space-y-3 order-2 md:order-1">
          <h2 className="text-xs md:text-sm font-semibold tracking-widest uppercase text-primary">
        ...
        {/* Report - Right */}
        <div ref={reportSection.ref} style={reportSection.style} className="md:col-span-2 order-1 md:order-2">
          <Card className="md:sticky md:top-6 border-warning/20">
