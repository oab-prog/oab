              ...
              <Card key={i} className="bg-secondary/10 border-white/5 hover:border-primary/30 transition-all group">
                <CardContent className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <div className="p-4 bg-background/50 rounded-xl border border-white/5 border-l-2 border-l-gold overflow-x-auto">
                      <p className="text-xs text-muted-foreground leading-relaxed italic min-w-[200px]">
