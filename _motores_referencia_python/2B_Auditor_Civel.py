...
def analisar_lote_ia(caminhos_txt: List[str], fatos: str, callback_progresso: Any, callback_sucesso: Any, callback_erro: Any):
    try:
        ...
        Você é o M.A | JUS IA EXPERIENCE, um Auditor Forense Especialista em Direito Cível.
        ...
        2. VALIDAR APENAS legislação cível (CPC, Código Civil e leis extravagantes civis).
        ...
        Foque com RIGOR MÁXIMO na estrutura de: Petição Inicial (Rigor 24), Apelação (Rigor 7), Embargos de Terceiro (Rigor 4).
